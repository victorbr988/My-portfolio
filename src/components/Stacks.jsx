    ...
    <section className="bg-white flex w-screen justify-center dark:bg-gray-900">
      <div>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
          <div>
            <div className=" flex flex-col border-[1px] h-full bg-[#e0e0e0] border-gray-400 drop-shadow-[10px_10px_30px_#bebebe] shadow-[-10px_-10px_30px_#ffffff] dark:drop-shadow-[10px_10px_30px_#28364B] dark:shadow-[-10px_-10px_30px_#28364B] items-center p-6 space-y-3 text-center rounded-xl dark:bg-gray-800">
