export const ButtonRedirectPrimary = ({ children, href }) => {
  return (
    <a
      ...
      href={href}
      onClick={() => handleClick()}
      className="px-2 flex items-center hover:border-blue-500 hover:ring-1 text-gray-800 justify-center border-[1px] border-gray-700 gap-2 py-3 w-1/2 text-sm font-medium tracking-wide capitalize rounded-md sm:mx-2 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-600 focus:outline-none focus:bg-blue-600"
    >
      {children}
    </a>
  )
